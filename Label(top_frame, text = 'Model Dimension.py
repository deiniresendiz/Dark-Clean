...
center = Frame(window, bg='gray2', width=50, height=40, padx=3, pady=3).grid(row=1, columnspan=3)
...
btm_frame = Frame(window, bg='white', width = 450, height = 45, pady=3).grid(row = 3, columnspan = 3)
btm_frame2 = Frame(window, bg='lavender', width = 450, height = 60, pady=3).grid(row = 4, columnspan = 3)
